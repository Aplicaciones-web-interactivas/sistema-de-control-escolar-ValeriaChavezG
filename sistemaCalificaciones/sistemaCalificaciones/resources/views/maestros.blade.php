            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('maestros.nuevo') }}" method="post">
                        ...
                        <div class="mb-3">
                            <label for="nom_materia" class="form-label">Materia impartida</label>
                            <input type="text" class="form-control" id="nom_materia" name="nom_materia" required>
                        </div>
                        <div class="mb-3">
    ...
    <table class="table mt-3">
        <thead>
            <tr>
                ...
                <th>Nombre de la materia impartida</th>
                <th>correo</th>
                <th>Grupo</th>
            </tr>
        </thead>
